      ...
      <div className="space-y-6">
        <div className="space-y-4">
          ...
          <p className="text-xl text-gray-300 leading-relaxed">
            깃헙 액션을 로컬에서 실행하고 싶다는 욕구를 느껴보셨나요?<br />
        ...
        <div className="space-y-4">
          ...
          <p className="text-xl text-gray-300 leading-relaxed">
            깃헙 클라우드 컴퓨터 말고 직접 aws의 컴퓨터에서 작업을 실행시키고 싶으신가요?<br />
            <span className="text-white font-semibold">(커스텀 러너)</span>
          </p>
        </div>
        
        <div className="space-y-4">
          <h3 className="text-2xl font-bold text-purple-400">4.</h3>
          <p className="text-xl text-gray-300 leading-relaxed">
            뱅샐 코드리뷰 시 사용중인 Pn 룰에 대해 들어보셨나요?<br />
            <span className="text-white font-semibold">커뮤니케이션 비용을 줄이고 싶으신가요?</span>
          </p>
        </div>
      </div>
    </div>
