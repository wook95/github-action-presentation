      ...
      <div className="space-y-8 max-w-4xl">
        <div className="grid grid-cols-2 gap-12 max-w-5xl">
          <div className="space-y-6">
            <Image src={cd1} alt="PR 생성 자동화 이미지" width={1034} height={95} className="w-full" priority />
          </div>

          <div className="space-y-6">
            <Image src={cd2} alt="PR 생성 자동화 이미지" width={1034} height={95} className="w-full" priority />
          </div>

          <div className="space-y-6">
            <Image src={cd4} alt="PR 생성 자동화 이미지" width={1034} height={95} className="w-full" priority />
          </div>
          <div className="space-y-6">
            <Image src={cd3} alt="PR 생성 자동화 이미지" width={1034} height={95} className="w-full" priority />
          </div>
        </div>
