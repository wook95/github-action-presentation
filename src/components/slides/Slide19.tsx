    ...
    <div className="h-full p-8">
      ...
      <div className="grid grid-cols-2 gap-12 h-3/4">
        <div className="space-y-6">
          <Image src={pr1} alt="PR 생성 자동화 이미지" width={1666} height={450} className="w-full h-68" priority />
        ...
        <div className="space-y-6">
          <Image src={pr2} alt="PR 생성 자동화 이미지" width={1666} height={450} className="w-full h-auto" priority />
          <div className="space-y-3">
